    ...
    switch (filter) {
      case 'canceled':
        return {
          ...
          icon: (
            <svg style={{ width: '32px', height: '32px', color: '#00ff94' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      case 'all':
        return {
          ...
          icon: (
            <svg style={{ width: '32px', height: '32px', color: '#00d4ff' }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
