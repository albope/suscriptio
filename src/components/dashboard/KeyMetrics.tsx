    ...
    <>
      ...
      >
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            ...
            <p style={{ fontSize: '13px', color: 'rgba(255, 255, 255, 0.4)' }}>
              {subscriptionsByFrequency.monthly} {t('dashboard.monthly')} ·{' '}
              {subscriptionsByFrequency.yearly} {t('dashboard.yearly')}
            </p>
          </div>
          <div
            style={{
        ...
        <div
          style={{
            ...
            height: '2px',
            background:
              'linear-gradient(90deg, #3b82f6 0%, rgba(59, 130, 246, 0.3) 50%, transparent 100%)',
            borderRadius: '1px',
            opacity: 0.6,
          }}
        />
      ...
      >
        ...
        <div
          style={{
            ...
            height: '2px',
            background:
              'linear-gradient(90deg, #22c55e 0%, rgba(34, 197, 94, 0.3) 50%, transparent 100%)',
            borderRadius: '1px',
            opacity: 0.6,
          }}
        />
      ...
      >
        ...
        >
          ...
          >
            <svg
              style={{ width: '22px', height: '22px', color: '#f59e0b' }}
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
              strokeWidth={1.5}
        ...
        <div
          style={{
            ...
            height: '2px',
            background:
              'linear-gradient(90deg, #f59e0b 0%, rgba(245, 158, 11, 0.3) 50%, transparent 100%)',
            borderRadius: '1px',
            opacity: 0.6,
          }}
        />
