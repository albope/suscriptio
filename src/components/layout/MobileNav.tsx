      ...
      <div style={{ display: 'flex', justifyContent: 'space-around' }}>
        ...
        <Link
          ...
          style={{
            ...
            alignItems: 'center',
            padding: '12px 24px',
            color: isActive('/settings') ? '#00d4ff' : '#666666',
            textDecoration: 'none',
            transition: 'color 0.2s ease',
          }}
        >
          <div
            style={{
              padding: '10px',
              borderRadius: '12px',
              background: isActive('/settings') ? 'rgba(0, 212, 255, 0.15)' : 'transparent',
              boxShadow: isActive('/settings') ? '0 0 15px rgba(0, 212, 255, 0.3)' : 'none',
              transition: 'all 0.2s ease',
            }}
          >
            <svg style={{ width: '24px', height: '24px' }} fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <span style={{ fontSize: '11px', marginTop: '4px', fontWeight: 500 }}>{t('nav.settings')}</span>
        </Link>
      </div>
    </nav>
  );
